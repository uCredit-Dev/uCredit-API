  ...
  distributions: [
    {
      ...
      fine_requirements: [
        {
          description:
            "<b>Computer Ethics(601.104).</b><p>Practical Ethics for Future Leaders (660.400/406) may be used as a substitute for the computer ethics requirement for </p><p>the BS program, but does not count towards the CS total credits at all.</p>",
          required_credits: 1,
...
export const allMajors = [baIS, bsCS];
