  ...
  distributions: [
    {
      ...
      double_count: ['Humanities (H) Distribution', 'Social Science (S) Distribution', 'Other (N/E/Q) Distribution', 'Writing Intensive'],
        fine_requirements: [
        {
          description:
    ...
    },
    {
      ...
      criteria: "H[A]",
      double_count: ['Economics Core', 'Economics Electives', 'Mathematics', 'Statistics', 'Writing Intensive'],
    },
    {
  ...
  distributions: [
    {
      ...
      double_count: ['Economics', 'Foreign Language', 'History'],
      fine_requirements: [
        {
          required_credits: 3,
    ...
    },
    {
      ...
      double_count: ['Political Science', 'Foreign Language', 'History'],
      fine_requirements: [
        {
          required_credits: 3,
    ...
    },
    {
      ...
      double_count: ['Political Science', 'Economics', 'History'],
    },
    {
      name: "Focus Area",
      required_credits: 12,
    ...
    },
    {
      ...
      double_count: ['Political Science', 'Economics', 'Foreign Language'], 
      fine_requirements: [
        {
          required_credits: 3,
          description:
  ...
  distributions: [
    {
      ...
      required_credits: 39,
      min_credits_per_course: 3,
      double_count: ['Natural Sciences', 'Quantitative Studies', 'Liberal Arts', 'Writing Intensive'],
      description:
...
const bsMolCell = {
  ...
  distributions: [
    ...
    },
    {
      ...
      criteria: "H[A]",
      double_count: ['Chemistry', 'Physics', 'Mathematics', 'Upper Level Electives', 'Biology Research Requirement', 'Writing Intensive'],
    },
    {
  ...
  distributions: [
    {
      ...
      double_count: ['Two Focal Areas', 'Humanities (H) Distribution', 'Social Sciences (S) Distribution', 'Other (N/E/Q) Distribution', 'Writing Intensive'],
      fine_requirements: [
        {
    ...
    },
    {
      ...
      criteria:
        'COGS-COGPSY[T]^OR^COGS-LING[T]^OR^COGS-COMPCG[T]^OR^COGS-NEURO[T]^OR^COGS-PHLMND[T]',
      double_count: ['One Course from each Focal Area', 'Math', 'Humanities (H) Distribution', 'Social Sciences (S) Distribution', 'Other (N/E/Q) Distribution', 'Writing Intensive'],
      pathing: 2,
      fine_requirements: [
        {
          description:
    ...
    },
    {
      ...
      double_count: ['Math', 'Humanities (H) Distribution', 'Social Sciences (S) Distribution', 'Other (N/E/Q) Distribution', 'Writing Intensive'],
    },
    {
      name: 'Math',
      required_credits: 6,
    ...
    },
    {
      ...
      description:
        ...
        'These credits fulfilling the distribution requirement may overlap with major or minor requirements and the writing-intensive requirement.',
      criteria: 'H[A]',
      double_count: ['One Course from each Focal Area', 'Two Focal Areas', 'Upper Level Electives', 'Math', 'Writing Intensive'], 
    },
    {
      name: 'Social Science (S) Distribution',
      required_credits: 9,
