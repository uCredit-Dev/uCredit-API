...
describe("Adding a major", () => {
  ...
  it("should create associated distribution objects with new major_id", async () => {
    ...
    const csCount = await distributions.count({ plan_id: planRes._id, major_id: updatedPlan.major_ids[0]}); 
    const amsCount = await distributions.count({ plan_id: planRes._id, major_id: updatedPlan.major_ids[1]}); 
  ...
  it("should create associated fineReq objects with new major_id", async () => {
    ...
    const csCount = await fineRequirements.count({ plan_id: planRes._id, major_id: updatedPlan.major_ids[0]}); 
    const amsCount = await fineRequirements.count({ plan_id: planRes._id, major_id: updatedPlan.major_ids[1]}); 
